...
# https://drive.google.com/drive/folders/1CntsRuqwdw_Oe5VqSMefenWbPVzL3-d6
...
SENTS_PER_CHUNK = 20
SENT_OVERLAP = 2
MAX_TOKENS = 1300     # safety cap (trim if 20 sentences are too long)
